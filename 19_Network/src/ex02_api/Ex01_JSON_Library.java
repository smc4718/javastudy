...
public class Ex01_JSON_Library {
   ...
   * 2. 자바스크립트 객체 표기법
   * 3. 객체는 중괄호 {}로 묶어서 표기한다. (자바에서는 배열이 중괄호{} 이니 JSON 이랑 다름)
  ...
  public static void ex03() {
    ...
    // String -> JSONObject 객체로 변환 (객체니까 JSONObject 로 처리해야 한다.)
    JSONObject obj = new JSONObject(str);
  
    // 원하는 Key(Property)를 가져오기         < Map 이었을 때 우리가 썼을 코드 ↓ >
    // JSONObject 가 Map 기반으로 만들어져 있기 때문에 동일하게 쓴다.
